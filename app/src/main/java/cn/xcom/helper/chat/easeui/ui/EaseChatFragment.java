package cn.xcom.helper.chat.easeui.ui;
...
import cn.xcom.helper.chat.easeui.EaseConstant;
...
import cn.xcom.helper.chat.easeui.utils.EaseUserUtils;
import cn.xcom.helper.chat.easeui.widget.EaseAlertDialog;
import cn.xcom.helper.chat.easeui.widget.EaseChatExtendMenu;
import cn.xcom.helper.chat.easeui.widget.EaseChatInputMenu;
import cn.xcom.helper.chat.easeui.widget.EaseChatMessageList;
import cn.xcom.helper.chat.easeui.widget.EaseVoiceRecorderView;
import cn.xcom.helper.chat.easeui.widget.chatrow.EaseCustomChatRowProvider;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void registerExtendMenuItem(){
        for(int i = 0; i < itemStrings.length; i++){
            inputMenu.registerExtendMenuItem(itemStrings[i], itemdrawables[i], itemIds[i], (EaseChatExtendMenu.EaseChatExtendMenuItemClickListener) extendMenuItemClickListener);
        }
    }
